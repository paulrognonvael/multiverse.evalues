...
for(n.sim in c(100, 250, 500, 750, 1000, 1500, 2000, 2500, 5000, 10000)){
  ...
  for(i in 1:nb.sim){
    ...
    supp.stats = hypsupp(formula=my.formula, data=datareg, family='binomial', 
                         softrank=TRUE, mixtevalue=FALSE, BF=FALSE, p.to.e = TRUE)$stats
  ...
  write.csv(softrankevalues.res,paste0('simulations/FDR/logreg/logsoftevalues.sim.n',n.sim,'.csv'),row.names = FALSE)
  ...
  write.csv(calib1.res,paste0('simulations/FDR/logreg/logcalib1.sim.n',n.sim,'.csv'),row.names = FALSE)
  ...
  write.csv(calib2.res,paste0('simulations/FDR/logreg/logcalib2.sim.n',n.sim,'.csv'),row.names = FALSE)
  ...
  write.csv(calib3.res,paste0('simulations/FDR/logreg/logcalib3.sim.n',n.sim,'.csv'),row.names = FALSE)
  ...
  write.csv(calib4.res,paste0('simulations/FDR/logreg/logcalib4.sim.n',n.sim,'.csv'),row.names = FALSE)
  summary.sim.calib4 = as.matrix(t(colMeans(calib4.res)))
  summary.calib4.res = rbind(summary.calib4.res, summary.sim.calib4)
}

write.csv(summary.mixt.res,paste0('simulations/FDR/logreg/summaries.logmixt.sim.csv'),row.names = FALSE)
write.csv(summary.soft.res,paste0('simulations/FDR/logreg/summaries.logsoft.sim.csv'),row.names = FALSE)
write.csv(summary.bf.res,paste0('simulations/FDR/logreg/summaries.logbf.sim.csv'),row.names = FALSE)
write.csv(summary.p.values.res,paste0('simulations/FDR/logreg/summaries.pvalues.sim.csv'),row.names = FALSE)
write.csv(summary.calib1.res,paste0('simulations/FDR/logreg/summaries.logcalib1.sim.csv'),row.names = FALSE)
write.csv(summary.calib2.res,paste0('simulations/FDR/logreg/summaries.logcalib2.sim.csv'),row.names = FALSE)
write.csv(summary.calib3.res,paste0('simulations/FDR/logreg/summaries.logcalib3.sim.csv'),row.names = FALSE)
write.csv(summary.calib4.res,paste0('simulations/FDR/logreg/summaries.logcalib4.sim.csv'),row.names = FALSE)
...
summary.all.res=rbind(summary.mixt.res,
                      ...
                      summary.calib3.res,
                      summary.calib4.res)
write.csv(summary.all.res,'~/GitHub/multiverse.evalues/simulations/FDR/logreg/summaries.all.csv',row.names = FALSE)
